...
let equationsList = []
let playerList =[]
let colorsList= {red:{x:0, y:0},blue:{x:0, y:0},green:{x:0, y:0},purple:{x:0, y:0},pink:{x:0, y:0},black:{x:0, y:0},grey:{x:0, y:0},yellow:{x:0, y:0},brown:{x:0,y:0},turquoise:{x:0,y:0}}
